...
<div class="kyros-sidebar fixed inset-y-0 left-0 z-50 w-64 transform transition-transform duration-300 ease-in-out lg:translate-x-0 flex flex-col"
    ...
    <nav style="flex:1;padding:14px 10px;overflow-y:auto;">
        ...
        <p class="kyros-section-label" style="font-size:.625rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--c-border-2);padding:0 12px;margin-bottom:8px;">General</p>
        ...
        <a href="<?php echo BASE_URL; ?>/admin/barbershops" <?php echo _nav_link('barbershops', $_activePage); ?>>
            ...
            <span class="kyros-nav-label">Barberías</span>
        </a>
        ...
        <a href="<?php echo BASE_URL; ?>/admin/users" <?php echo _nav_link('users', $_activePage); ?>>
            ...
            <span class="kyros-nav-label">Usuarios</span>
        </a>

        <p class="kyros-section-label" style="font-size:.625rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--c-border-2);padding:0 12px;margin:16px 0 8px;">Finanzas</p>

        <a href="<?php echo BASE_URL; ?>/admin/licenses" <?php echo _nav_link('licenses', $_activePage); ?>>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/>
            </svg>
            <span class="kyros-nav-label">Licencias</span>
        </a>
        ...
        <a href="<?php echo BASE_URL; ?>/admin/license-modules" <?php echo _nav_link('license-modules', $_activePage); ?>>
            ...
            <span class="kyros-nav-label">Modulos Licencia</span>
        </a>
        ...
        <a href="<?php echo BASE_URL; ?>/admin/coupons" <?php echo _nav_link('coupons', $_activePage); ?>>
            ...
            <span class="kyros-nav-label">Cupones</span>
        </a>
        ...
        <a href="<?php echo BASE_URL; ?>/admin/reports" <?php echo _nav_link('reports', $_activePage); ?>>
            ...
            <span class="kyros-nav-label">Reportes</span>
        </a>
